...
void CAgoraObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CAgoraObject *_t = static_cast<CAgoraObject *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CAgoraObject::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_videoStopped)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CAgoraObject::*_t)(const QString & , unsigned int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_joinedChannelSuccess)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (CAgoraObject::*_t)(unsigned int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_userJoined)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (CAgoraObject::*_t)(unsigned int , USER_OFFLINE_REASON_TYPE );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_userOffline)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (CAgoraObject::*_t)(int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_firstLocalVideoFrame)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (CAgoraObject::*_t)(unsigned int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_firstRemoteVideoDecoded)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (CAgoraObject::*_t)(unsigned int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_firstRemoteVideoFrameDrawn)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (CAgoraObject::*_t)(const LocalVideoStats & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_localVideoStats)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (CAgoraObject::*_t)(const RemoteVideoStats & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_remoteVideoStats)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (CAgoraObject::*_t)(const RtcStats & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_rtcStats)) {
                *result = 9;
                return;
            }
        }
        {
            typedef void (CAgoraObject::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_lastmileQuality)) {
                *result = 10;
                return;
            }
        }
        {
            typedef void (CAgoraObject::*_t)(const LastmileProbeResult & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CAgoraObject::sender_lastmileProbeResult)) {
                *result = 11;
                return;
            }
        }
...
const QMetaObject CAgoraObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CAgoraObject.data,
      qt_meta_data_CAgoraObject,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CAgoraObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CAgoraObject.stringdata0))
        return static_cast<void*>(const_cast< CAgoraObject*>(this));
